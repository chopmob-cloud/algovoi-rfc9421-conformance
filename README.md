...
| Scala | self-contained | Bouncy Castle | JDK `java.security` |
...
| Corpus | 374 vectors across 45 anchor sets | 78 (v1) / 89 (v2) cases across 6 sections |
...
Together the two corpora cover canonicalise → sign → verify end to end.
